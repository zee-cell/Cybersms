...
function banner() {
   ...
   echo -e "     ████████████████████████████████████████████████████████████████████
     ...
     ██          ▒▒████████████████████████████████████████▒▒          ██
     ██            ▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒            ██
     ██     Coded by: https://github.com/dan998                           ██
   ...
   echo -e "$Green   Welcome to Cybersms $NC"
   echo -e "$Green     With Cybersms You can send, Anonymous Text Message $NC"
   sleep 1
...
function byemsg() {
   ...
   sleep 1
   echo -e "$Green Closing Cybersms... $NC"
   sleep 1
   echo " "
...
function VERSION() {
   echo " "
   echo -e "$BGreen Cybersms version: v1.5(Non-Supported)"
   echo " "
}
...
function SENDSMS() {
   ...
   then
      ...
      echo "  "
      echo -e "$BGreen SUCCESSFULLY SENT $NC"
      echo "  "
      echo -e "$BGreen ---------------------------------------------- $NC"
      echo "$SMSRESULT"
      echo -e "$BGreen ---------------------------------------------- $NC"
